...
export const LEVEL_NARRATIVES_120: Record<number, LevelStoryData> = {
  ...
  2: {
    title: "L'Archivio della Bodleian Library",
    subtitle: "Sala di Lettura dei Manoscritti Rari • Oxford 1928",
    prologue: "Nella solenne sala di lettura della Bodleian Library di Oxford, tra monumentali scaffalature ricolme di tomi membranacei e la luce dorata che filtra dalle vetrate gotiche, Bellini ha studiato le cronache dei conquistadores. Trova gli 8 elementi dell'indagine bibliografica.",
    resolution: "Tra le note miniate del codice andino hai scoperto il tracciato segreto: i registri indicano che il secondo passaggio dell'itinerario templare si trova a Parigi!",
    unlockedSecret: "'Chi cerca la via di Paititi deve seguire le rotte dell'Ordine del Tempio. Da Oxford a Parigi, la conoscenza fu custodita nel silenzio delle pietre.' - Glossa segreta della Bodleiana, 1928",
  },
  3: {
  ...
  19: {
    title: "Lo Scompartimento dell'Espresso Notturno 1928",
    subtitle: "Treno Simplon-Orient-Express • Da Parigi a Venezia",
    prologue: "Nello scompartimento in boiserie di mogano e velluto blu del treno notturno Simplon-Orient-Express, Bellini organizza le carte dell'indagine parigina mentre il convoglio sferraglia verso le Alpi e l'Italia. Trova gli 8 indizi del viaggio su rotaia.",
    resolution: "Confrontando il biglietto ferroviario, il cronometro e la mappa della laguna, confermi la destinazione: Venezia e i segreti dei maestri vetrai di Murano!",
    unlockedSecret: "'Il fischio della locomotiva squarcia la notte transalpina. La Mano Oscura ci segue, ma il secondo tassello ci attende all'alba in laguna.' - Diario di Bellini, pag. 28",
  },
  20: {
    title: "Il Sanctum Sotterraneo dei Templari di Parigi",
    subtitle: "Camera Capitolare Segreta • Milestone di Tappa 2",
    prologue: "Nell'antico sanctum sotterraneo della Commanderia dei Templari di Parigi, illuminato da un monumentale candelabro liturgico, sull'altare in pietra coperto di velluto cremisi riposa la seconda reliquia. Trova gli 8 elementi cerimoniali per sigillare la Tappa 2.",
    resolution: "TAPPA 2 CONCLUSA! Hai sbloccato la reliquia 'La Croce Patente d'Argento' e il secondo frammento della mappa di Paititi!",
    unlockedSecret: "'La croce d'argento vibra leggermente vicino all'acqua della laguna. Ci guiderà fino alla bottega dell'alchimista a Venezia!' - Diario di Bellini, pag. 30",
  },
