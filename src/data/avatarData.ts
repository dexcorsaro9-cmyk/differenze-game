...
export const EXPLORERS: Record<'samira' | 'mateo', ExplorerCharacter> = {
  samira: {
    ...
    image: assetUrl('/avatars/female_samira.webp'),
    backImage: assetUrl('/avatars/female_samira_back.webp'),
    portrait: assetUrl('/avatars/female_samira.webp'),
  ...
  mateo: {
    ...
    image: assetUrl('/avatars/male_mateo.webp'),
    backImage: assetUrl('/avatars/male_mateo_back.webp'),
    portrait: assetUrl('/avatars/male_mateo.webp'),
...
export const ALL_OUTFITS: WardrobeOutfit[] = [
  ...
  },
  {
    ...
    image: assetUrl('/avatars/female_samira_speleo.webp'),
    backImage: assetUrl('/avatars/female_samira_speleo_back.webp'),
    tag: 'Speleologia',
  },
  {
    id: 'samira_rain',
    ...
    image: assetUrl('/avatars/female_samira_rain.webp'),
    backImage: assetUrl('/avatars/female_samira_rain_back.webp'),
    tag: 'Resistente',
  },
  {
    id: 'samira_cenote',
    ...
    image: assetUrl('/avatars/female_samira_cenote.webp'),
    backImage: assetUrl('/avatars/female_samira_cenote_back.webp'),
    tag: 'Subacquea',
  },
  {
    id: 'samira_society',
    ...
    image: assetUrl('/avatars/female_samira_society.webp'),
    backImage: assetUrl('/avatars/female_samira_society_back.webp'),
    tag: 'Accademica',
  },
  {
    id: 'samira_inti',
    ...
    image: assetUrl('/avatars/female_samira_inti.webp'),
    backImage: assetUrl('/avatars/female_samira_inti_back.webp'),
    tag: 'Reliquia Sacra',
  },
  ...
  },
  {
    ...
    requiredLevel: 15,
    perk: { type: 'coin_boost', value: 10, label: '+10% Monete guadagnate' },
    image: assetUrl('/avatars/male_mateo_recon.webp'),
    backImage: assetUrl('/avatars/male_mateo_recon_back.webp'),
    tag: 'Alpinismo',
  },
  {
    id: 'mateo_alpine',
    ...
    requiredLevel: 30,
    perk: { type: 'freeze_boost', value: 5, label: '+5s Durata Congelamento' },
    image: assetUrl('/avatars/male_mateo_alpine.webp'),
    backImage: assetUrl('/avatars/male_mateo_alpine_back.webp'),
    tag: 'Termico',
  },
  {
    id: 'mateo_jungle',
    ...
    requiredLevel: 50,
    perk: { type: 'radar_boost', value: 25, label: '+25% Ampiezza Radar' },
    image: assetUrl('/avatars/male_mateo_jungle.webp'),
    backImage: assetUrl('/avatars/male_mateo_jungle_back.webp'),
    tag: 'Fluviale',
  },
  {
    id: 'mateo_guild',
    ...
    requiredLevel: 75,
    perk: { type: 'free_shield', value: 1, label: '1 Scudo Errore Gratuito' },
    image: assetUrl('/avatars/male_mateo_guild.webp'),
    backImage: assetUrl('/avatars/male_mateo_guild_back.webp'),
    tag: 'Geodetico',
  },
  {
    id: 'mateo_guard',
    ...
    requiredRelics: 4,
    perk: { type: 'coin_boost', value: 25, label: '+25% Monete Totali' },
    image: assetUrl('/avatars/male_mateo_guard.webp'),
    backImage: assetUrl('/avatars/male_mateo_guard_back.webp'),
    tag: 'Reliquia Sacra',
  },
];
