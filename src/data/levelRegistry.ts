    ...
    if (isLevelOne) {
      diffsForLevel = [
        ...
        },
        {
          ...
          name: "Gli Occhiali da Lettura sul Banco",
          riddle: "Due cerchi di vetro e filo d'argento che moltiplicano la vista per chi decifra scritture sbiadite.",
          loreClue: "Bellini li ha lasciati cadere nella fretta dell'agguato: senza di essi non avrebbe potuto leggere la mappa."
        },
        {
          id: `lvl${id}_d3`,
          x: 52.5,
        ...
        },
        {
          ...
          riddle: "Custoditi nell'intaglio di mogano, sfuggiti alla vista e socchiusi nella fretta della fuga.",
          loreClue: "Le mappe originali del XVI secolo tracciate dai missionari gesuiti dispersi nella giungla."
        },
        {
          id: `lvl${id}_d5`,
          x: 75.4,
        ...
        },
        {
          ...
          radius: 7.0,
          clueType: 'stolen_relic',
          name: "Il Pennino d'Oro da Scrittura",
          riddle: "Uno stilo d'ottone e pennino dorato adagiato sulla pergamena accanto all'inchiostro.",
          loreClue: "Dono dell'Accademia Archeologica di Parigi per la decifrazione dei glifi precolombiani."
        },
        {
          id: `lvl${id}_d8`,
          x: 86.0,
      ...
      diffsForLevel = [
        ...
        },
        {
          ...
          radius: 7.5,
          clueType: 'dark_seal',
          name: "L'Elisir Alchemico nella Fiala",
          riddle: "Piccola ampolla di vetro che custodisce il reagente per rivelare gli inchiostri simpatici.",
          loreClue: "Il liquido reagisce al calore della lanterna, facendo apparire le lettere nascoste tra le righe del grimorio."
        },
      ];
